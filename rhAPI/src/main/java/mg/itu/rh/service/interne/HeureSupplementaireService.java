...
public class HeureSupplementaireService {
    ...
    public List<HeureSupplementaire> getByContratAndMoisAndAnnee(Long idContrat, int mois, int annee) {
        return heureSupplementaireRepository.findByContratAndMoisAndAnnee(idContrat, mois, annee);
    }
