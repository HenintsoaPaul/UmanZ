...
public class PdfGenerationService {
    ...
    public ByteArrayOutputStream generateCertificate(String name) throws DocumentException {
    ...
    public ByteArrayOutputStream generateUnemploymentCertificate(String name) throws DocumentException {
        Document document = new Document();
        ByteArrayOutputStream outputStream = new ByteArrayOutputStream();
