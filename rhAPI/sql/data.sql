...
INSERT INTO talent (nom, prenom, mail, password) VALUES
                                                     ...
                                                     ('Martin', 'Alice', 'alice.martin@example.com', 'password2'),
                                                     ('Petit', 'Louis', 'louis.petit@example.com', 'password3'),
                                                     ('Durand', 'Emma', 'emma.durand@example.com', 'password4'),
                                                     ('Leroy', 'Paul', 'paul.leroy@example.com', 'password5');

INSERT INTO poste (nom_poste, description_poste) VALUES
                                                     ('Développeur', 'Responsable du développement des applications'),
...
INSERT INTO annonce (date_annonce, entreprise, date_expiration, id_poste) VALUES
                                                                              ('2024-01-01', 'Tech Corp', '2024-03-01', 1),
...
INSERT INTO formation (nom_formation, date_debut, date_fin) VALUES
                                                                ('Formation Java', '2023-01-10', '2023-03-10'),
...
INSERT INTO type_rupture (nom_type_rupture) VALUES
                                                ('Fin de contrat'),
                                                ('Démission'),
                                                ('Licenciement'),
                                                ('Rupture amiable'),
...
INSERT INTO contrat (contrat, date_debut, date_fin, salaire_horaire, nb_jour_semaine, nb_jour_conge_an, nb_heure_jour, id_poste, id_talent, id_type_contrat) VALUES
                                                                                                                                                                 ('Contrat CDI Développeur', '2023-01-01', '2024-01-01', 20.00, 5, 25, 8.0, 1, 1, 3),
...
INSERT INTO entretien (date_creation, date_validation, note, motif, id_enfant, id_annonce, id_etat_entretien, id_talent) VALUES
                                                                                                                             ('2023-02-15', '2023-02-20', 85, 'Entretien positif', NULL, 1, 4, 1),
...
INSERT INTO rupture (date_rupture, motif, id_type_rupture, id_contrat) VALUES
                                                                           ('2024-01-01', 'Fin de contrat', 1, 1),
                                                                           ('2023-08-01', 'Fin de CDD', 1, 2),
                                                                           ('2023-10-01', 'Licenciement', 3, 3);

INSERT INTO poste (nom_poste, description_poste) VALUES
                                                     ('Ingénieur DevOps', 'Assurer le déploiement et l''intégration continue des applications'),
...
INSERT INTO annonce (date_annonce, entreprise, date_expiration, id_poste) VALUES
                                                                              ('2024-10-15', 'Innovative Solutions', '2025-01-15', 6),
...
INSERT INTO competence_annonce (id_competence, id_annonce, point) VALUES
                                                                      (14, 1, 5),  -- Docker
                                                                      (15, 1, 5),  -- Kubernetes
                                                                      (12, 1, 4);  -- Leadership
...
INSERT INTO competence_annonce (id_competence, id_annonce, point) VALUES
                                                                      (9, 5, 5),  -- JavaScript
                                                                      (5, 5, 4),  -- UX/UI Design
                                                                      (13, 5, 4); -- Développement frontend

-- Architecte Logiciel (poste 11)
INSERT INTO competence_annonce (id_competence, id_annonce, point) VALUES
                                                                      (13, 6, 5), -- Développement backend
                                                                      (14, 6, 4), -- Docker
                                                                      (1, 6, 4);  -- Cloud Computing

-- Ingénieur DevOps (poste 6)
INSERT INTO experience_poste (id_poste, id_annonce, ans) VALUES
    (6, 1, 3); -- 3 ans d'expérience en Ingénierie DevOps

-- Data Scientist (poste 7)
INSERT INTO experience_poste (id_poste, id_annonce, ans) VALUES
    (7, 2, 2); -- 2 ans d'expérience en Data Science

-- Responsable RH (poste 8)
INSERT INTO experience_poste (id_poste, id_annonce, ans) VALUES
    (8, 3, 5); -- 5 ans d'expérience en gestion des ressources humaines

-- Consultant (poste 9)
INSERT INTO experience_poste (id_poste, id_annonce, ans) VALUES
    (9, 4, 4); -- 4 ans d'expérience en consultation

-- Développeur Frontend (poste 10)
INSERT INTO experience_poste (id_poste, id_annonce, ans) VALUES
    (10, 5, 3); -- 3 ans d'expérience en développement frontend

-- Architecte Logiciel (poste 11)
INSERT INTO experience_poste (id_poste, id_annonce, ans) VALUES
    (11, 6, 6); -- 6 ans d'expérience en architecture logicielle

INSERT INTO conge (date_debut, nb_jour, motif, id_contrat) VALUES
                                                               ('2024-12-01', 5, 'Congé annuel', 1),  -- Congé annuel pour le contrat 1
