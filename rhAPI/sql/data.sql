...
VALUES ('au revoir', 'Au revoir :)'),
       ...
       ('test technique',
        'Le test technique se déroule en ligne. Vous recevrez un lien pour y accéder une fois votre candidature validée.'),
       ...
       ('compétences',
        'Nous recherchons des compétences spécifiques selon les postes. Veuillez consulter l''annonce pour plus de détails.'),
       ('contrat', 'Le type de contrat dépend de votre profil et de notre offre actuelle.'),
       ('formation',
        'Nous offrons des programmes de formation pour développer les compétences nécessaires après votre embauche.'),
       ...
       ('aide',
        'Je suis là pour vous aider ! Posez-moi vos questions sur le recrutement ou le processus de candidature.'),
       ('contact',
        'Pour toute question spécifique, vous pouvez nous contacter par email à recrutement@entreprise.com.');
...
VALUES ('Comment géreriez-vous un conflit dans une équipe de projet ?'),
...
VALUES ('Quelles technologies utiliseriez-vous pour gérer un projet Agile ?', 1),
...
INSERT INTO evaluation (date_evaluation, id_talent)
VALUES ('2024-11-01', 1),
       ('2024-11-02', 2),
       ('2024-11-03', 3),
       ('2024-11-04', 4),
...
INSERT INTO resultat_technique (note, date_resultat, id_domaine, id_talent)
VALUES (8.0, '2024-11-01 10:00:00', 1, 1),
...
INSERT INTO question_evaluation (id_question_projet, id_evaluation, note, reponse)
VALUES (1, 1, 8.5, 'Il est essentiel d''écouter chaque partie et de trouver un compromis.'),
       ...
       (5, 4, 8.0,
        'Organiser des réunions régulières pour suivre les progrès et ajuster les priorités en conséquence.'),
       (1, 5, 7.5, 'Prendre une approche calme et structurée pour gérer la pression et respecter les délais.');

-- Question 1
INSERT INTO question_technique (question, id_domaine)
VALUES ('Quelle est la meilleure pratique pour la gestion de la mémoire dans une application Java ?', 1);

-- Question 2
INSERT INTO question_technique (question, id_domaine)
VALUES ('Comment optimiser les requêtes SQL dans une base de données relationnelle ?', 2);

-- Question 3
INSERT INTO question_technique (question, id_domaine)
VALUES ('Comment sécuriser une application web utilisant JWT (JSON Web Token) ?', 3);

-- Question 4
INSERT INTO question_technique (question, id_domaine)
VALUES ('Quelle approche recommanderiez-vous pour gérer les exceptions dans une application Spring Boot ?', 4);

-- Question 5
INSERT INTO question_technique (question, id_domaine)
VALUES ('Quel est l''intérêt de la méthode `Stream.forEach()` en Java ?', 5);

-- Réponses pour la question 1
INSERT INTO reponse (reponse, note, id_question_technique)
VALUES ('Utiliser des variables locales et éviter les références globales.', 3.5, 1),
...
INSERT INTO reponse (reponse, note, id_question_technique)
VALUES ('Utiliser des index sur les colonnes fréquemment utilisées dans les conditions de jointure ou de filtrage.',
        4.5, 2),
...
INSERT INTO reponse (reponse, note, id_question_technique)
VALUES ('Stocker le token dans le "localStorage" côté client.', 2.5, 3),
...
INSERT INTO reponse (reponse, note, id_question_technique)
VALUES ('Utiliser des blocs "try-catch" dans chaque méthode pour attraper les exceptions.', 3.0, 4),
       ('Utiliser des contrôleurs globaux annotés avec "@ControllerAdvice" pour centraliser la gestion des erreurs.',
        4.0, 4),
       ('Lancer directement les exceptions sans les gérer dans les méthodes.', 2.0, 4);

-- Réponses pour la question 5
INSERT INTO reponse (reponse, note, id_question_technique)
VALUES ('Elle permet de traiter les éléments d''une collection de manière parallèle, ce qui améliore les performances.',
        4.0, 5),
...
-- Question 1
INSERT INTO question_projet (question)
VALUES ('Comment abordez-vous la gestion des risques dans un projet technique ?');

-- Question 2
INSERT INTO question_projet (question)
VALUES ('Quelles stratégies utilisez-vous pour motiver une équipe sur un projet long terme ?');

-- Question 3
INSERT INTO question_projet (question)
VALUES ('De quelle manière ajustez-vous un projet lorsque les attentes du client changent en cours de réalisation ?');

-- Question 4
INSERT INTO question_projet (question)
VALUES ('Comment assurez-vous que tous les membres de l''équipe comprennent bien leurs rôles et responsabilités ?');

-- Question 5
INSERT INTO question_projet (question)
VALUES ('Quelles sont vos méthodes pour faire face à des délais serrés dans un projet ?');
